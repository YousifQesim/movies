...
const afterRemove=fav.filter(
  (favo)=>favo.id!==movie.id
)
setfav(afterRemove);
}
...
const values={movies,addfav,searchValue,setsearchValue,fav,setMovies,popularMovies,setCategory,category,AddToCard,RemoveFromCard,cartIteam,removieFav,addBY5,remBY5};
  return (
